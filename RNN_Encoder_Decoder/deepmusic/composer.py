...
class Composer:
    ...
    def _parse_args(args):
        ...
        training_args.add_argument('--save_every', type=int, default=10, help='nb of mini-batch step before creating a model checkpoint')
        training_args.add_argument('--batch_size', type=int, default=32, help='mini-batch size')
    ...
    def _main_test(self):
        ...
        self.saver = tf.train.import_meta_graph(os.path.join(self.model_dir,'model.ckpt.meta'))
        # model_list = self._get_model_list()
        model_list = [os.path.join(self.model_dir,'model.ckpt')]
